<x-main>
    <div class="container">
        <div class="columns mt-6 mb-6">
            ...
            <div class="column">
                <form method="POST" action="{{ route('deliveries.destroy', $delivery->id) }}" onsubmit="return confirm('Are you sure you want to delete this delivery?');">                    @csrf
                    @csrf
                    @method('DELETE')
                    ...
                    <div class="content">
                        <form action="{{ route('deliveries.update', $delivery) }}" method="POST">
                            ...
                            <br>
                                ...
                                <input
                                    value="{{ old('order_deadline', $delivery) }}"
                                    type="datetime-local"
                            ...
                            <a href="{{ route('deliveries.show', $delivery->id) }}" class="button is-primary">Cancel</a>
                        </form>
                    </div>
                </div>
            </div>
